...
const firebaseConfig = {
  ...
  apiKey: "AIzaSyB5klKtGwM1txbdledGOxZOIxjZr5SXCN4",
  authDomain: "flexit-da21f.firebaseapp.com",
  databaseURL: "https://flexit-da21f-default-rtdb.firebaseio.com",
  projectId: "flexit-da21f",
  storageBucket: "flexit-da21f.appspot.com",
  messagingSenderId: "545245001960",
  appId: "1:545245001960:web:55a8400b8d31da9c85715d",
};
...
CountRef.on("value", (snapshot) => {
  ...
  met_armcircles = 0.6;
  calories =
    (((armcircles * 4) / 60) * met_armcircles * 3.5 * 65) / 200 +
    (((pushups * 2) / 60) * met_pushups * 3.5 * 65) / 200 +
    (((squats * 4) / 60) * met_squats * 3.5 * 65) / 200;
